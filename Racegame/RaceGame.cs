...
namespace Racegame
{
    public partial class Racegame : Form
    {
        ...
        public Racegame(MainMenu main, Character c1, Character c2, Map map1)
        {
            ...
            p2 = new Player("Player 2", c2, this, null, Keys.Up, Keys.Down, Keys.Right, Keys.Left, Keys.ControlKey, 500, 140, 64, 64, FuelBox, Player2Box, Fueladder2, Speed2, 3);
            p1 = new Player("Player 1", c1, this, null, Keys.W, Keys.S, Keys.D, Keys.A, Keys.ShiftKey, 520, 80, 64, 64, FuelBox2, Player1Box, Fueladder, Speed1, 3);
